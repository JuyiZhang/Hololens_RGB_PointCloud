...
namespace winrt::HL2UnityPlugin::implementation
{
    struct HL2ResearchMode : HL2ResearchModeT<HL2ResearchMode>
    {
        ...
        com_array<uint8_t> GetPVTextureBuffer();
    ...
    private:
        ...
        size_t m_PVTextureBufferSize = 0;
        ...
        std::atomic_bool m_PVTextureUpdated = false;
        ...
        bool IsVideoFrameProcessorWantedAndReady(HL2ResearchMode* pHL2ResearchMode);
